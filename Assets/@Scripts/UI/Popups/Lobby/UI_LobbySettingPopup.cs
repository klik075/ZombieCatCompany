...
public class UI_LobbySettingPopup : UI_UGUI, IUI_Popup
{
    enum GameObjects
    {
        //Content   
    ...
    protected override void Awake()
    {
        ...
        GetButton((int)Buttons.SettingFrame3Button).onClick.AddListener(() => { PlayButtonClickSound(); OnClickedResetButton(); });
    }
    ...
    private void OnClickedResetButton()
    {
        ...
        UI_DeleteDataPopup popup = UIManager.Instance.ShowPopupUI<UI_DeleteDataPopup>();
    }
